...
anscombe <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\anscombe.txt",header=TRUE)
attach(anscombe)
...
huber <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\huber.txt",header=TRUE)
attach(huber)
...
bonds <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\bonds.txt",header=TRUE)
attach(bonds)
...
production <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\production.txt",header=TRUE)
attach(production)
...
cleaning <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\cleaning.txt",header=TRUE)
attach(cleaning)
...
confood1 <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\confood1.txt",header=TRUE)
attach(confood1)
...
responsetransformation <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\responsetransformation.txt",header=TRUE)
...
#Exercise 3.5.1
airfares <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\airfares.txt",header=TRUE)
attach(airfares)
...
#Exercise 3.5.4
glakes <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\glakes.txt",header=TRUE)
attach(glakes)
