...
travel <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\travel.txt",header=TRUE)
attach(travel)
...
latour <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\Latour.txt", header=TRUE)
attach(latour)
