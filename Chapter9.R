...
confood2 <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\confood2.txt", header=TRUE)
attach(confood2)
...
BayArea <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\BayArea.txt",header=TRUE)
attach(BayArea)
...
boxoffice <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\boxoffice.txt", header=TRUE)
attach(boxoffice)
