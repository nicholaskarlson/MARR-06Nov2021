...
changeover_times <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\changeover_times.txt",header=TRUE)
...
playbill <- read.csv("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\playbill.csv",header=TRUE)
attach(playbill)
...
invoice <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\invoices.txt",header=TRUE)
attach(invoice)
...
#Exercise 2.8.5
problem5 <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\Ch2Problem5.txt",header=TRUE)
attach(problem5)
