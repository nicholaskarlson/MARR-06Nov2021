# For this code to run on your machine, replace hard-coded directory location
# "C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\"
# with the correct location on your machine.

# That is, search for, and replace "C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\"
...
nyc <- read.csv("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\nyc.csv", header=TRUE)
attach(nyc)
...
# load(file = "C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\caution.rda")
#
# attach(caution)
# pairs(caution$y~caution$x1+caution$x2)
#
# Figure 6.5 on page 160
# m1 <- lm(caution$y~caution$x1+caution$x2)
# StanRes1 <- rstandard(m1)
# par(mfrow=c(2,2))
...
nonlinearx <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\nonlinearx.txt",header=TRUE)
attach(nonlinearx)
...
defects <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\defects.txt", header=TRUE)
attach(defects)
...
magazines <- read.csv("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\magazines.csv", header=TRUE)
attach(magazines)
...
circulation <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\circulation.txt", header=TRUE, sep="\t")
attach(circulation)
...
profsalary <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\profsalary.txt",header=TRUE)
attach(profsalary)
...
bridge <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\bridge.txt", header=TRUE)
attach(bridge)
...
Bordeaux <- read.csv("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\Bordeaux.csv", header=TRUE)
attach(Bordeaux)
...
storks <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\storks.txt",header=TRUE)
attach(storks)
...
cars04 <- read.csv("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\cars04.csv",header=TRUE)
attach(cars04)
...
krafft <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\krafft.txt",header=TRUE)
attach(krafft)
