...
cleaningwtd <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\cleaningwtd.txt",header=TRUE)
attach(cleaningwtd)
...
Houston <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\HoustonRealEstate.txt",header=TRUE)
attach(Houston)
