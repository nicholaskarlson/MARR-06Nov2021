...
prostateTraining <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\prostateTraining.txt", header=TRUE)
...
prostateTest <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\prostateTest.txt", header=TRUE)
attach(prostateTest)
...
prostateAlldata <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\prostateAlldata.txt", header=TRUE)
...
#Exercise 7.5.2
Hald <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\Haldcement.txt",header=TRUE)
attach(Hald)
