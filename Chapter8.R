...
MichelinFood <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\MichelinFood.txt", header=TRUE)
attach(MichelinFood)
...
MichelinNY <- read.csv("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\MichelinNY.csv", header=TRUE)
attach(MichelinNY)
...
playoffs <- read.table("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\playoffs.txt",header=TRUE)
attach(playoffs)
...
ex833 <- read.csv("C:\\Users\\root\\Documents\\Rprojects\\MARR-06Nov2021\\MARR\\HeartDisease.csv", header=TRUE)
attach(ex833)
